...
import StudentForm.FormGetSetThongTinLop;
...
public class StudentsLogin extends javax.swing.JFrame {
    ...
    public void send() {
        ...
        if (user.equals(strnull) || pass.equals(strnull)) {
            ...
            try {
                boolean blean = true;
                ps = DBConnect.cnn.prepareStatement("select fldTenDangNhapSinhVien,fldPasswordSinhVien from tblStudentLogin ");
                rs = ps.executeQuery();
                while (rs.next()) {
                    String username = rs.getString("fldTenDangNhapSinhVien");
                    String password = rs.getString("fldPasswordSinhVien");
